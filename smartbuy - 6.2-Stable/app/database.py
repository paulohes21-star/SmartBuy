...
# SMARTBUY_SPRINT_6_3_EIP
_sprint6_or_previous_init_db = init_db

def init_db() -> None:
    _sprint6_or_previous_init_db()
    from app.integration.eip_schema import apply_eip_schema
    from app.integration.registry import register_runtime_connectors
    apply_eip_schema()
    register_runtime_connectors()
